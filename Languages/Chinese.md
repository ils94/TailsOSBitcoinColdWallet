# 很重要的是保持您的TailsOS版本更新，以避免任何可能窃取您比特币的恶意攻击！如果您使用的是过时版本的TailsOS，请记住在访问您的离线钱包时绝对不要连接到互联网！使用第二个USB驱动器创建您的在线钱包，或使用其他方法在Android或iOS上拥有在线钱包，并使用通过QR码签署您的交易的方法。如果您违反任何安全规则，包括忽视此警告，我将不承担任何关于您比特币被盗的责任。
