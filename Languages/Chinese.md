# 保持你的TailsOS版本更新非常重要，以避免任何类型的恶意攻击，可能会偷走你的比特币！如果你使用的是过期版本的TailsOS，请记住在访问你的离线钱包时绝对不要连接到互联网！使用第二个USB驱动器创建你的在线钱包，或使用其他方式在Android或iOS上拥有在线钱包，并使用气隙方法通过二维码签署你的交易。如果你违反任何安全规则，包括忽略此警告，我对你的比特币被盗不负任何责任。
