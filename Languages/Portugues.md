# É muito importante manter a sua versão do TailsOS atualizada para evitar qualquer tipo de ataque malicioso que possa roubar seus Bitcoins! Se utilizar uma versão desatualizada do TailsOS, lembre-se de NUNCA se conectar à internet ao acessar sua carteira offline! Utilize um segundo pendrive para criar sua carteira online, ou utilize outros meios de ter uma carteira online no Android ou iOS, e utilize formas para assinar suas transações por QR Code. Não sou responsável por qualquer furto de seus Bitcoins caso você quebre qualquer regra de segurança, inclusive ignorar este aviso.
