...
4. Wybierz **USB image**, klikając przycisk **Flash from file**. Twój pendrive powinien zostać automatycznie wykryty. Jeśli nie, upewnij się, że wybierasz odpowiedni pendrive. Następnie kliknij przycisk **Flash!**.
