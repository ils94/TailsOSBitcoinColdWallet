...
2. Después de descargar la imagen USB, verifique la descarga yendo a la página de descargas y subiendo su imagen descargada haciendo clic en el botón que dice **Seleccione su descarga para verificar...**. Si la verificación es exitosa, puede continuar; de lo contrario, debe volver a descargar la imagen. Luego, descargue balenaEtcher desde este enlace: https://tails.net/etcher/balenaEtcher-portable.exe
