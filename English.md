...
1. Go to https://tails.net/install/download/index.pt.html and download the USB Image.

![enter image description here](https://github.com/ils94/TailsOSBitcoinWallet/blob/main/Images/01.PNG?raw=true)

2. After downloading the USB image, download balenaEtcher from this link: https://tails.net/etcher/balenaEtcher-portable.exe
...
10. Create a strong password to encrypt your Tails OS installation.
